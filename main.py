...
x_Frekans = np.array(fullCollumn(data,0))
x_SaldiriAcisi = np.array(fullCollumn(data,1))
x_AkorUzunlugu = np.array(fullCollumn(data,2))
x_SerbestAkisHizi = np.array(fullCollumn(data,3))
x_YerDegistirme = np.array(fullCollumn(data,4))
x_SesBasinci = np.array(fullCollumn(data,5))
